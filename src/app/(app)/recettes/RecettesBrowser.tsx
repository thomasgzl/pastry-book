 ...
 * filtre par source portés par l'URL (`?q=`, `?source=`), jamais par un état
 * React local perdu à la navigation : `router.replace` met à jour l'URL à
 * chaque changement, `useSearchParams` en reste la seule source de vérité.
 * Ainsi, revenir depuis une fiche recette (bouton précédent du navigateur)
